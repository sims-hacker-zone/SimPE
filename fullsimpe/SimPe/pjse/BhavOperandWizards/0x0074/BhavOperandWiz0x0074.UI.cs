	...
	public partial class UI : UserControl, pjse.iBhavOperandWizForm
	{
		...
		private void ShowStrChooser(pjse.GS.GlobalStr strResource, TextBox textAnim)
		{
			pjse.FileTable.Entry[] entryArray =
				pjse.FileTable.GFT[FileTypes.STR, inst.Parent.GroupForScope(pjse.Scope.Private), (uint)strResource] ??
				pjse.FileTable.GFT[FileTypes.STR, inst.Parent.GroupForScope(pjse.Scope.SemiGlobal), (uint)strResource];
