...
namespace whse.PrimitiveWizards.Wiz0x0070
{
	public partial class UI : UserControl, pjse.iBhavOperandWizForm
	{
		...
		{
			pjse.FileTable.Entry[] entryArray = comboEffectScope.SelectedIndex < 0 ? (pjse.FileTable.Entry[])null : pjse.FileTable.GFT[FileTypes.STR, inst.Parent.GroupForScope(scopeArray[comboEffectScope.SelectedIndex]), (ushort)pjse.GS.GlobalStr.Effect];
