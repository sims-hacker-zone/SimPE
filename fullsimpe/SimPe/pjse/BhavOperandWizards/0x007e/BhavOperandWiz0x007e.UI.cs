...
namespace whse.PrimitiveWizards.Wiz0x007e
{
	public partial class UI : UserControl, pjse.iBhavOperandWizForm
	{
		...
		{
			pjse.FileTable.Entry[] entryArray = comboStrScope.SelectedIndex < 0 ? (pjse.FileTable.Entry[])null : pjse.FileTable.GFT[FileTypes.STR, inst.Parent.GroupForScope(scopeArray[comboStrScope.SelectedIndex]), doStrRes.Value];
