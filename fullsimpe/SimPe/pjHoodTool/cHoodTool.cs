    ...
    class cHoodTool : SimPe.Interfaces.AbstractTool, ITool, ICommandLine
    {
        ...
        void AddSim(string outPath, string hood, string hoodName, StreamWriter w, ExtSDesc sdsc)
        {
            ...
            if (sdsc.Business != null)
            {
                ...
                {
                    business = Localization.GetString("SimPe.PackedFiles.Wrapper.JobAssignf." + Enum.GetName(typeof(JobAssignment), (ushort)sdsc.Business.Assignment));
        ...
        public string[] Help()
        {
            return new string[] { "-rufio -out {outpath} {-hood hood} {-group group}", "Export Neighborhood data" };
        }
