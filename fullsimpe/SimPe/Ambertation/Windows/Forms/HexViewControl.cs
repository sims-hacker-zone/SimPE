...
namespace Ambertation.Windows.Forms
{
	...
	public class HexViewControl : UserControl
	{
		...
		{			
			...
			border = new Image[8];
			border[0] = Image.FromStream(this.GetType().Assembly.GetManifestResourceStream("SimPe.img.tl.png"));
			border[1] = Image.FromStream(this.GetType().Assembly.GetManifestResourceStream("SimPe.img.t.png"));
			border[2] = Image.FromStream(this.GetType().Assembly.GetManifestResourceStream("SimPe.img.tr.png"));
			border[3] = Image.FromStream(this.GetType().Assembly.GetManifestResourceStream("SimPe.img.r.png"));
			border[4] = Image.FromStream(this.GetType().Assembly.GetManifestResourceStream("SimPe.img.br.png"));
			border[5] = Image.FromStream(this.GetType().Assembly.GetManifestResourceStream("SimPe.img.b.png"));
			border[6] = Image.FromStream(this.GetType().Assembly.GetManifestResourceStream("SimPe.img.bl.png"));
			border[7] = Image.FromStream(this.GetType().Assembly.GetManifestResourceStream("SimPe.img.l.png"));
