...
namespace Ambertation.Drawing
{
	...
	public class FloodFiller : AbstractFloodFiller
	{
		...
		public unsafe void RecursiveFloodFill8(
			byte* scan0,
			int x,
			int y,
			Size bmpsize,
		...
		public unsafe void RecursiveFloodFill4(
			byte* scan0,
			int x,
			int y,
			Size bmpsize,
		...
		public unsafe void QueueFloodFill(
			byte* scan0,
			int x,
			int y,
			Size bmpsize,
		...
		public unsafe void QueueFloodFill8(
			byte* scan0,
			int x,
			int y,
			Size bmpsize,
		...
		public unsafe void QueueFloodFill4(
			byte* scan0,
			int x,
			int y,
			Size bmpsize,
