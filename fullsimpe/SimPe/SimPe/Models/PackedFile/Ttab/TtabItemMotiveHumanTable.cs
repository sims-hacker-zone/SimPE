...
namespace SimPe.Models.PackedFile.Ttab
{
	public partial class TtabItemMotiveHumanTable(TtabItem parent) : ObservableObject
	{
		...
		[ObservableProperty]
		private ObservableCollection<TtabItemMotiveHumanGroup> groups = [];
	...
	{
		[ObservableProperty]
		private TtabItemMotiveHumanTable parent = parent;

		[ObservableProperty]
		private ObservableCollection<TtabItemMotiveHumanSingleItem> items = [];
	...
	{
		[ObservableProperty]
		private TtabItemMotiveHumanGroup parent = parent;
