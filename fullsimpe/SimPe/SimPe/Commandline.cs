...
namespace SimPe
{
    ...
    public class Commandline
    {
        ...
        static void Overridelayout(string name)
        {
            ...
            System.IO.Stream s = typeof(Commandline).Assembly.GetManifestResourceStream("SimPe.data." + name);
            if (s != null)
            {
                try
                {
            ...
            s = typeof(Commandline).Assembly.GetManifestResourceStream("SimPe.data." + name2);
            if (s != null)
            {
                try
                {
        ...
        public static void CompleteSetup(string namer)
        {
            ...
            string path;
            System.IO.Stream s = typeof(Commandline).Assembly.GetManifestResourceStream("SimPe.data." + namer);
