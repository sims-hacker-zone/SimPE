...
namespace SimPe.Data
{
	...
	public enum PackageFolders : uint
	{
		...
		StoreEdition = 0x1f,
		[DisplayName("Sims Life Stories")]
		LifeStories = 32,
		[DisplayName("Sims Pet Stories")]
		PetStories = 33,
		[DisplayName("Sims Castaway Stories")]
		CastawayStories = 34,
		[DisplayName("Sims 2 Savegames")]
		SaveGameSims2 = 35,
		[DisplayName("Sims Life Stories Savegames")]
		SaveGameLifeStories = 36,
		[DisplayName("Sims Pet Stories Savegames")]
		SaveGamePetStories = 37,
		[DisplayName("Sims Castaway Stories Savegames")]
