...
namespace SimPe.Plugin
{
	...
	public class WantsForm : System.Windows.Forms.Form
	{
		...
		internal void ListWants()
		{
			...
			itv.Images.Add(new System.Drawing.Bitmap(this.GetType().Assembly.GetManifestResourceStream("SimPe.img.subitems.png")));
			itv.Images.Add(new System.Drawing.Bitmap(this.GetType().Assembly.GetManifestResourceStream("SimPe.img.nothumb.png")));
            Wait.SubStart();
