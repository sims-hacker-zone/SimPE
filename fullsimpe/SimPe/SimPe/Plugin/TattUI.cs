...
namespace SimPe.Plugin
{
	...
	//System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			// tbVer
			//
			this.tbVer.AccessibleDescription = resources.GetString(
			...
			this.tbVer.RightToLeft = (
				(System.Windows.Forms.RightToLeft)(
					resources.GetObject("tbVer.RightToLeft")
				)
			);
			this.tbVer.ScrollBars = (
			...
			// tbRes
			//
			this.tbRes.AccessibleDescription = resources.GetString(
			...
			// tbFlname
			//
			this.tbFlname.AccessibleDescription = resources.GetString(
				"tbFlname.AccessibleDescription"
			);
			this.tbFlname.AccessibleName = resources.GetString(
			...
			this.tbFlname.TextChanged += new System.EventHandler(
				this.tbFlname_TextChanged
			);
			//
			// label4
			//
			...
			this.lb.HorizontalExtent = (
				(int)(resources.GetObject("lb.HorizontalExtent"))
			);
			this.lb.HorizontalScrollbar = (
