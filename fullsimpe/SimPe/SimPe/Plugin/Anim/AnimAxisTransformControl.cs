...
namespace SimPe.Plugin.Anim
{
	...
	public class AnimAxisTransformControl : System.Windows.Forms.UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			// label1
			//
			this.label1.AccessibleDescription = resources.GetString(
			...
			// label2
			//
			this.label2.AccessibleDescription = resources.GetString(
			...
			// label3
			//
			this.label3.AccessibleDescription = resources.GetString(
			...
			// label4
			//
			this.label4.AccessibleDescription = resources.GetString(
			...
			// cbEvent
			//
			this.cbEvent.AccessibleDescription = resources.GetString(
			...
			this.cbEvent.ImageAlign = (
				(System.Drawing.ContentAlignment)(
					resources.GetObject("cbEvent.ImageAlign")
				)
			);
			this.cbEvent.ImageIndex = (
			...
			// tbParameter
			//
			this.tbParameter.AccessibleDescription = resources.GetString(
				"tbParameter.AccessibleDescription"
			);
			this.tbParameter.AccessibleName = resources.GetString(
			...
			this.tbParameter.AutoSize = (
				(bool)(resources.GetObject("tbParameter.AutoSize"))
			);
			this.tbParameter.BackgroundImage = (
				(System.Drawing.Image)(
			...
			this.tbParameter.Enabled = (
				(bool)(resources.GetObject("tbParameter.Enabled"))
			);
			this.tbParameter.Font = (
			...
			// tbU1
			//
			this.tbU1.AccessibleDescription = resources.GetString(
			...
			// tbU2
			//
			this.tbU2.AccessibleDescription = resources.GetString(
			...
			// tbU2Float
			//
			this.tbU2Float.AccessibleDescription = resources.GetString(
				"tbU2Float.AccessibleDescription"
			);
			this.tbU2Float.AccessibleName = resources.GetString(
			...
			this.tbU2Float.AutoSize = (
				(bool)(resources.GetObject("tbU2Float.AutoSize"))
			);
			this.tbU2Float.BackgroundImage = (
			...
			// tbU1Float
			//
			this.tbU1Float.AccessibleDescription = resources.GetString(
				"tbU1Float.AccessibleDescription"
			);
			this.tbU1Float.AccessibleName = resources.GetString(
			...
			this.tbU1Float.AutoSize = (
				(bool)(resources.GetObject("tbU1Float.AutoSize"))
			);
			this.tbU1Float.BackgroundImage = (
			...
			// tbParameterFloat
			//
			this.tbParameterFloat.AccessibleDescription = resources.GetString(
				"tbParameterFloat.AccessibleDescription"
			);
			this.tbParameterFloat.AccessibleName = resources.GetString(
			...
			this.tbParameterFloat.AutoSize = (
				(bool)(resources.GetObject("tbParameterFloat.AutoSize"))
			);
			this.tbParameterFloat.BackgroundImage = (
				(System.Drawing.Image)(
			...
			this.tbParameterFloat.Enabled = (
				(bool)(resources.GetObject("tbParameterFloat.Enabled"))
			);
			this.tbParameterFloat.Font = (
			...
			// tbU2Hex
			//
			this.tbU2Hex.AccessibleDescription = resources.GetString(
			...
			// tbU1Hex
			//
			this.tbU1Hex.AccessibleDescription = resources.GetString(
			...
			// tbParameterHex
			//
			this.tbParameterHex.AccessibleDescription = resources.GetString(
				"tbParameterHex.AccessibleDescription"
			);
			this.tbParameterHex.AccessibleName = resources.GetString(
			...
			this.tbParameterHex.AutoSize = (
				(bool)(resources.GetObject("tbParameterHex.AutoSize"))
			);
			this.tbParameterHex.BackgroundImage = (
				(System.Drawing.Image)(
			...
			this.tbParameterHex.Enabled = (
				(bool)(resources.GetObject("tbParameterHex.Enabled"))
			);
			this.tbParameterHex.Font = (
			...
			// tbU2Bin
			//
			this.tbU2Bin.AccessibleDescription = resources.GetString(
			...
			// tbU1Bin
			//
			this.tbU1Bin.AccessibleDescription = resources.GetString(
			...
			// tbParameterBin
			//
			this.tbParameterBin.AccessibleDescription = resources.GetString(
				"tbParameterBin.AccessibleDescription"
			);
			this.tbParameterBin.AccessibleName = resources.GetString(
			...
			this.tbParameterBin.AutoSize = (
				(bool)(resources.GetObject("tbParameterBin.AutoSize"))
			);
			this.tbParameterBin.BackgroundImage = (
				(System.Drawing.Image)(
			...
			this.tbParameterBin.Enabled = (
				(bool)(resources.GetObject("tbParameterBin.Enabled"))
			);
			this.tbParameterBin.Font = (
			...
			// llDelete
			//
			this.llDelete.AccessibleDescription = resources.GetString(
				"llDelete.AccessibleDescription"
			);
			this.llDelete.AccessibleName = resources.GetString(
			...
			this.llDelete.ImageAlign = (
				(System.Drawing.ContentAlignment)(
					resources.GetObject("llDelete.ImageAlign")
				)
			);
			this.llDelete.ImageIndex = (
			...
			// cbParentLock
			//
			this.cbParentLock.AccessibleDescription = resources.GetString(
				"cbParentLock.AccessibleDescription"
			);
			this.cbParentLock.AccessibleName = resources.GetString(
			...
			this.cbParentLock.BackgroundImage = (
				(System.Drawing.Image)(
					resources.GetObject("cbParentLock.BackgroundImage")
				)
			);
			this.cbParentLock.CheckAlign = (
				(System.Drawing.ContentAlignment)(
