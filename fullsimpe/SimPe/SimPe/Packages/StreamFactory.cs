...
namespace SimPe.Packages
{
	...
	{
		internal static Dictionary<string, StreamItem> streams = new Dictionary<string, StreamItem>();
		static List<string> locked = new List<string>();
		...
		static void InitTable()
		{
			if (streams == null)
			{
				streams = new Dictionary<string, StreamItem>();
			}
		}
