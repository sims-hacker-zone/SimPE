...
namespace SimPe.PackedFiles
{
    ...
    public sealed class TypeRegistry : IWrapperRegistry, IProviderRegistry, IToolRegistry, IHelpRegistry, ISettingsRegistry, ICommandLineRegistry
    {
        ...
        public TypeRegistry()
        {
            ...
            il.Images.Add(System.Drawing.Image.FromStream(this.GetType().Assembly.GetManifestResourceStream("SimPe.img.empty.png")));
            il.Images.Add(System.Drawing.Image.FromStream(this.GetType().Assembly.GetManifestResourceStream("SimPe.img.binary.png")));
        }
