...
namespace SimPe.PackedFiles.Lotd
{
	...
	public partial class LoteUI : Windows.Forms.WrapperBaseControl, IPackedFileUI
	{
		...
		public LoteUI()
		{
			...
			cbtype.Items.Clear();
			cbtype.Items.Add(Ltxt.Ltxt.LotType.Unknown);
			cbtype.Items.Add(Ltxt.Ltxt.LotType.Residential);
			cbtype.Items.Add(Ltxt.Ltxt.LotType.Community);
			if (PathProvider.Global.EPInstalled > 0)
			{
				cbtype.Items.Add(Ltxt.Ltxt.LotType.Dorm);
				cbtype.Items.Add(Ltxt.Ltxt.LotType.GreekHouse);
				cbtype.Items.Add(Ltxt.Ltxt.LotType.SecretSociety);
			}
			if (PathProvider.Global.EPInstalled > 9)
			{
				cbtype.Items.Add(Ltxt.Ltxt.LotType.Hotel);
				cbtype.Items.Add(Ltxt.Ltxt.LotType.SecretHoliday);
			}
			if (PathProvider.Global.EPInstalled > 11)
			{
				cbtype.Items.Add(Ltxt.Ltxt.LotType.Hobby);
			}
			if (PathProvider.Global.EPInstalled > 15)
			{
				cbtype.Items.Add(Ltxt.Ltxt.LotType.ApartmentBase);
				cbtype.Items.Add(Ltxt.Ltxt.LotType.ApartmentSublot);
				cbtype.Items.Add(Ltxt.Ltxt.LotType.Witches);
			}
		}
		...
		protected override void RefreshGUI()
		{
			...
			rtLotDef.Text =
				Wrapper.LotName
				+ " is a "
				+ Enum.GetName(typeof(Ltxt.Ltxt.LotType), Wrapper.Type)
				+ " Lot\r\n\r\n"
				+ "It is "
		...
		private void cbtype_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			Wrapper.Type = Enum.IsDefined(typeof(Ltxt.Ltxt.LotType), cbtype.SelectedItem) ? (Ltxt.Ltxt.LotType)cbtype.SelectedItem : Ltxt.Ltxt.LotType.Unknown;
