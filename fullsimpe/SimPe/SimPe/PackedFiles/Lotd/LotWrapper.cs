...
namespace SimPe.PackedFiles.Lotd
{
		...
		: AbstractWrapper, IFileWrapper, IFileWrapperSaveExtension
	{
		...
		ushort subver = 0;
		Size sz;
		Ltxt.Ltxt.Rotation rotation = Ltxt.Ltxt.Rotation.toLeft;
		#endregion
		...
		public Ltxt.Ltxt.LotType Type { get; set; } = Ltxt.Ltxt.LotType.Residential;
		public byte LotRoads { get; set; } = 0x00;
		public byte LotRotation
		{
			get => (byte)rotation;
			set => rotation = (Ltxt.Ltxt.Rotation)value;
		}
		...
		protected override void Unserialize(System.IO.BinaryReader reader)
		{
			...
			Type = (Ltxt.Ltxt.LotType)reader.ReadByte();

			LotRoads = reader.ReadByte();
			rotation = (Ltxt.Ltxt.Rotation)reader.ReadByte();
