...
namespace SimPe
{
    ...
    public partial class infocheck : UserControl
	{
        ...
        private string ProductVirsion
        {
            get
            {
                if (System.IO.File.Exists(System.IO.Path.Combine(ReleaseDir, "SimPe.exe")))
                {
                    System.Diagnostics.FileVersionInfo bver = System.Diagnostics.FileVersionInfo.GetVersionInfo(System.IO.Path.Combine(ReleaseDir, "SimPe.exe"));
