...
public enum FileTypes : uint
{
	...
	/// Sim DNA
	/// </summary>
	[FileType(DisplayName = "Sim DNA")] SDNA = 0xEBFEE33F,
	...
	/// ID Number
	/// </summary>
	[FileType(DisplayName = "ID Number")] IDNO = 0xAC8A7A2E,
	...
	/// Object Lua
	/// </summary>
	[FileType(DisplayName = "Object Lua")] OLUA = 0x9012468B,
	...
	/// Age Data
	/// </summary>
	[FileType(DisplayName = "Age Data")] AGED = 0xAC598EAC,
	...
	/// Name Map
	/// </summary>
	[FileType(DisplayName = "Name Map")] NMAP = 0x4E6D6150,
	...
	/// Game Tip
	/// </summary>
	[FileType(DisplayName = "Game Tip")] GTIP = 0xB1827A47,
	...
	/// Sim Scores
	/// </summary>
	[FileType(DisplayName = "Sim Scores")] SCOR = 0x3053CF74,
	...
	/// Popups
	/// </summary>
	[FileType(DisplayName = "Popups")] POPS = 0x2C310F46,
	...
	/// Collection
	/// </summary>
	[FileType(DisplayName = "Collection")] COLL = 0x6C4F359D,
	...
	/// jpg/tga/png Image
	/// </summary>
	[FileType(DisplayName = "jpg/tga/png Image",
		Extension = "jpg")]
	// TODO(autinerd): Check if really all three picture formats are in this type
	IMG = 0x856DDBAC,
	...
	/// Audio Test
	/// </summary>
	[FileType(DisplayName = "Audio Test")] AUDT = 0xEBFEE345,
	...
	/// FX Sound
	/// </summary>
	[FileType(DisplayName = "FX Sound")] FXSD = 0x8DB5E4C2,
	...
	/// Hitlist
	/// </summary>
	[FileType(DisplayName = "Hitlist")] HLS = 0x7B1ACFCD,
