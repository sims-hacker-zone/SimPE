...
namespace SimPe.Sims2.Views.Windows;
...
public partial class NeighborhoodBrowser : Window
{
	...
	public async Task<NeighborhoodViewModel> ProcessNeighborhood(IStorageFolder folder)
	{
		...
		// }
		// Models.Resource.Resource idno = nbg.PackageFile.FindFiles(FileTypes.IDNO, null, null, null).FirstOrDefault();
		// if (idno == null)
		// {
		// 	return null;
		// }
		...
		// Models.Resource.Resource ctss = nbg.PackageFile.FindFiles(FileTypes.CTSS, null, null, null).FirstOrDefault();
		// if (ctss == null)
		// {
		// 	return null;
		// }
		// ctss.ReadContent();
		// ILookup<int, Models.Resource.Str.StrItem> indices = (ctss.Wrapper as Models.Resource.Str.Str).ByIndex;
	...
	public async Task<NeighborhoodViewModel> ProcessSubNeighborhood(IEnumerable<IStorageFile> folder_items,
		IStorageFile file)
	{
		return null;
		// MainWindowViewModel vm = DataContext as MainWindowViewModel;
