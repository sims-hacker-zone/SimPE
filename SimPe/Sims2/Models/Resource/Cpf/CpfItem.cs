...
{
	[ObservableProperty] private Cpf parent = parent;

	[ObservableProperty] private EnumDisplayNameItem<CpfItemType> type;

	[ObservableProperty] private string key;

	[ObservableProperty] private uint uintValue;

	[ObservableProperty] private string stringValue;

	[ObservableProperty] private float floatValue;
