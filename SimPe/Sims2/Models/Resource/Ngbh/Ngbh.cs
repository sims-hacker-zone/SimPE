...
using SimPe.Sims2.Views.Resource.Ngbh;

namespace SimPe.Sims2.Models.Resource.Ngbh;

public partial class Ngbh(Resource resource) : ObservableObject, IWrapper
{
	...
	[ObservableProperty] private string terrainType;

	[ObservableProperty] private NgbhSlot[] universalTokens = new NgbhSlot[2];

	[ObservableProperty] private ObservableCollection<NgbhSlot> lots = [];

	[ObservableProperty] private ObservableCollection<NgbhSlot> families = [];

	[ObservableProperty] private ObservableCollection<NgbhSlot> sims = [];

	[ObservableProperty] private byte customHoodMarker;

	[ObservableProperty] private uint ePReadyMarker;
