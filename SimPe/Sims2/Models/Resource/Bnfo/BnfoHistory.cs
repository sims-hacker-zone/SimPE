...
public partial class BnfoHistory(Bnfo parent) : ObservableObject
{
	...
	[ObservableProperty] private ushort unknown_01;

	[ObservableProperty] private int unknown_02;

	[ObservableProperty] private uint unknown_03;

	[ObservableProperty] private byte unknown_04;

	[ObservableProperty] private int unknown_05;

	[ObservableProperty] private uint unknown_06;

	[ObservableProperty] private uint unknown_07;

	[ObservableProperty] private uint unknown_08;

	[ObservableProperty] private int unknown_09;

	[ObservableProperty] private uint unknown_10;

	[ObservableProperty] private uint unknown_11;

	[ObservableProperty] private int unknown_12;

	[ObservableProperty] private uint unknown_13;

	[ObservableProperty] private byte unknown_14;

	[ObservableProperty] private uint unknown_15;

	[ObservableProperty] private int unknown_16;

	[ObservableProperty] private int unknown_17;

	[ObservableProperty] private int unknown_18;

	[ObservableProperty] private int unknown_19;
