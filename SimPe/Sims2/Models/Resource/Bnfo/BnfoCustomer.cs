...
public partial class BnfoCustomer(Bnfo parent) : ObservableObject
{
	...
	[ObservableProperty] private int loyalty;

	[ObservableProperty] private ObservableCollection<uint> data = [];

	[ObservableProperty] private ObservableCollection<uint> data2 = [];
