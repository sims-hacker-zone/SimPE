...
public partial class TtabItemMotiveAnimalTable(TtabItem parent) : ObservableObject
{
	...
	[ObservableProperty] private ObservableCollection<TtabItemMotiveAnimalGroup> groups = [];
...
{
	[ObservableProperty] private TtabItemMotiveAnimalTable parent = parent;

	[ObservableProperty] private ObservableCollection<TtabItemMotiveAnimalItem> items = [];
...
{
	[ObservableProperty] private TtabItemMotiveAnimalGroup parent = parent;

	[ObservableProperty] private ObservableCollection<TtabItemMotiveAnimalSingleItem> items = [];
...
{
	[ObservableProperty] private TtabItemMotiveAnimalItem parent = parent;
