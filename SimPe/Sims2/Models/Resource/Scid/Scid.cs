...
using SimPe.Sims2.Views.Resource.Scid;

namespace SimPe.Sims2.Models.Resource.Scid;

public partial class Scid(Resource resource) : ObservableObject, IWrapper
{
	...
	[ObservableProperty] private ushort sCID;
