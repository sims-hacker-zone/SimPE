...
using SimPe.Sims2.Views.Resource.Ltxt;

namespace SimPe.Sims2.Models.Resource.Ltxt;

public partial class Ltxt(Resource resource) : ObservableObject, IWrapper
{
	...
	[ObservableProperty] private LotRoads lotRoads;

	[ObservableProperty] private EnumDisplayNameItem<LotRotation> lotRotation;

	[ObservableProperty] private LotFlags lotFlags;
	...
	[ObservableProperty] private LotHobbyFlags lotHobbyFlags;
	...
	[ObservableProperty] private uint positionY;

	[ObservableProperty] private uint positionX;

	[ObservableProperty] private float lotElevation;

	[ObservableProperty] private uint lotInstance;

	[ObservableProperty] private EnumDisplayNameItem<LotOrientation> lotOrientation;

	[ObservableProperty] private string lotTexture;

	[ObservableProperty] private byte unknown_01;

	[ObservableProperty] private uint businessOwnerInstance;

	[ObservableProperty] private uint apartmentBaseInstance;

	[ObservableProperty] private byte[] unknown_02 = [0, 0, 0, 0, 0, 0, 0, 0, 0];

	[ObservableProperty] private ObservableCollection<SubLot> subLots = [];

	[ObservableProperty] private ObservableCollection<uint> unknown_03 = [];
