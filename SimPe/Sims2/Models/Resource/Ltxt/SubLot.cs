...
{
	[ObservableProperty] private Ltxt parent = parent;

	[ObservableProperty] private uint subLotInstance;

	[ObservableProperty] private uint familyInstance;

	[ObservableProperty] private uint unknown;

	[ObservableProperty] private uint roommateInstance;
