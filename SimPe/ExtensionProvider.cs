...
public class ExtensionProvider
{
	...
	/// </summary>
	public static Dictionary<ExtensionType, Avalonia.Platform.Storage.FilePickerFileType> ExtensionMap { get; } =
		new Dictionary<ExtensionType, Avalonia.Platform.Storage.FilePickerFileType>
		{
			...
			[ExtensionType.ExtractedFileDescriptor] =
				new Avalonia.Platform.Storage.FilePickerFileType("Extracted File Descriptor")
				{
					Patterns = GetExtractExtensions(".xml").ToList()
				},
			[ExtensionType.ExtrackedPackageDescriptor] =
				new Avalonia.Platform.Storage.FilePickerFileType("Extracted Package")
				{
					Patterns = new List<string>
					{
						"package.xml"
			...
			[ExtensionType.Sim2PackCommunity] =
				new Avalonia.Platform.Storage.FilePickerFileType("Sims 2 Community Package")
				{
					Patterns = new List<string>
					{
						"*.s2cp"
	...
	{
		return ExtensionMap.TryGetValue(type, out Avalonia.Platform.Storage.FilePickerFileType value)
			? value
			: new Avalonia.Platform.Storage.FilePickerFileType("Unknown Type")
				{ Patterns = new List<string> { "*.*" } };
	}
