...
namespace SimPe.Models.PackedFile.Ngbh
{
	...
	{
		[ObservableProperty]
		private NgbhSlot parent = parent;

		[ObservableProperty]
		private uint guid;

		[ObservableProperty]
		private CheckableFlagEnum<NgbhItemFlags> flags1;
		[ObservableProperty]
		private CheckableFlagEnum<NgbhItemFlags> flags2;

		[ObservableProperty]
		private uint inventoryNumber;

		[ObservableProperty]
		private ushort unknown;

		[ObservableProperty]
		private ObservableCollection<ushort> dataItems = [];
